 ...
 **/ 
public class TryRoughDisplay extends JFrame {
	private static final long serialVersionUID = 1L;
	private final Drawer drawer;

	
	
	public TryRoughDisplay(final BufferedImage[] images) {
...
//			File file = new File("images/test/bird.png");
		...
		TryRoughH2O.replaceHexLatticeWithRoughHexData(src, doubleLattice);
		...
		run(new TryRoughDisplay(images), sizex + 300, sizey + 100);
	}
